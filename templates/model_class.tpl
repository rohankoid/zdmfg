 ...
 * @author <?=$this->_author."\n"?>
 */
abstract class <?=$this->_namespace?>Model_ModelAbstract
{
    /**
     * Mapper associated with this model instance
     *
     * @var <?=$this->_namespace?>Model_ModelAbstract
     */
    protected $_mapper;
...
<?php endif; ?>
     ...
     *
     * @param array $data
     * @return <?=$this->_namespace?>Model_ModelAbstract
     */
...
<?php endif; ?>
     ...
     *
     * @see <?=$this->_namespace?>Model_DbTable_TableAbstract::getPrimaryKeyName()
     ...
     *
     * @see <?=$this->_namespace?>Model_Mapper_MapperAbstract::toArray()
     * @return array
     */
     ...
     *
     * @param <?=$this->_namespace?>Model_Mapper_MapperAbstract $mapper
     * @return <?=$this->_namespace?>Model_ModelAbstract
     */
     ...
     *
     * @see <?=$this->_namespace?>Model_Mapper_MapperAbstract::save()
     ...
     *
     * @param <?=$this->_namespace?>Model_ModelAbstract $model Object to be compared to
     ...
     */
/*    public function diff(<?=$this->_namespace?>Model_ModelAbstract $model,
     $ignorePrimaryKey = true, $relations = false, $load = true
        ...
        if ($relations) {
        	...
        	foreach($all_relations as $key => $property) {
        		...
        		if (is_null($value)) {
        			continue;
        		} elseif ($value instanceof <?=$this->_namespace?>Model_ModelAbstract)  {
        			...
        			foreach ($value as $val) {
        				if ($val instanceof <?=$this->_namespace?>Model_ModelAbstract) {
        		...
        		if (method_exists($model, $method)) {
        			...
        			if (is_null($other_value)) {
        				$other_value = array();
        			} elseif ($other_value instanceof <?=$this->_namespace?>Model_ModelAbstract) {
