 ...
 * @author <?=$this->_author."\n"?>
 */
abstract class <?=$this->_namespace?>Model_Mapper_MapperAbstract
{
    /**
     * $_dbTable - instance of <?=$this->_namespace?>Model_DbTable_TableAbstract
     *
     * @var <?=$this->_namespace?>Model_DbTable_TableAbstract
     */
    protected $_dbTable;
...
<?php endif; ?>
     ...
     *
     * @param <?=$this->_namespace?>Model_DbTable_TableAbstract $dbTable
     * @return <?=$this->_namespace?>Model_Mapper_MapperAbstract
     */
...
<?php endif; ?>
     ...
     * @param <?=$this->_namespace?>Model_ModelAbstract $model
    ...
    public function loadRelated($name, $model)
    {
        ...
        if (array_key_exists($name, $parents)) {
            ...
            $table_class = '<?=$this->_namespace?>Model_DbTable_' . $object_table_name;
            $rule = $name;
            $type = 'parent';
        } elseif (array_key_exists($name, $dependents)) {
            $property = $dependents[$name]['property'];
            $object_table_name = $dependents[$name]['table_name'];
            $ref_table_name = '<?=$this->_namespace?>Model_DbTable_' . $object_table_name;
            $rule = $name;
...
<?php endif; ?>
        ...
        $obj = $row->$method('<?=$this->_namespace?>Model_DbTable_' . $object_table_name, $rule);

        if (! empty($obj)) {
            $model_class = '<?=$this->_namespace?>Model_' . $object_table_name;
     ...
     *
     * @see <?=$this->_namespace?>Model_DbTable_TableAbstract::countAllRows()
     ...
     *
     * @see <?=$this->_namespace?>Model_DbTable_TableAbstract::countByQuery()
     ...
     *
     * @param <?=$this->_namespace?>Model_ModelAbstract $model The model to delete
     * @return int
     */
    ...
    {
        $adapter = new <?=$this->_namespace?>Model_Paginator($select, $this);
     ...
     * @return array All <?=$this->_namespace?>Model_ModelAbstract meeting the criteria
     */
     ...
     * @param <?=$this->_namespace?>Model_ModelAbstract|null $model
     * @return <?=$this->_namespace?>Model_ModelAbstract|null The matching models found or null if not found
     */
     ...
     *
     * @return <?=$this->_namespace?>Model_DbTable_TableAbstract
     */
     ...
     *
     * @param new <?=$this->_namespace?>Model_ModelAbstract $model
     * @return array
     */
     ...
     * @param <?=$this->_namespace?>Model_ModelAbstract|null $entry The object to load the data into, or null to have one created
     */
