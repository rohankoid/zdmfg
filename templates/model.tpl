 ...
 * @see <?=$this->_namespace?>Model_Mapper_<?=$this->_className . "\n"?>
 */
 ...
 * @author <?=$this->_author."\n"?>
 */
class <?=$this->_namespace?>Model_<?=$this->_className?> extends <?=$this->_includeModel->getParentClass() . "\n"?>
{
...
<?php foreach ($this->getForeignKeysInfo() as $key): ?>
     ...
     *
     * @var <?=$this->_namespace?>Model_<?=$this->_getClassName($key['foreign_tbl_name']) . "\n"?>
     */
...
<?php endif; ?>
     * @return <?=$this->_namespace?>Model_<?=$this->_className . "\n"?>
     */
...
<?php foreach ($this->getForeignKeysInfo() as $key): ?>
     ...
     *
     * @param <?=$this->_namespace?>Model_<?=$this->_getClassName($key['foreign_tbl_name'])?> $data
     * @return <?=$this->_namespace?>Model_<?=$this->_className . "\n"?>
     */
    public function set<?=$this->_getRelationName($key, 'parent')?>(<?=$this->_namespace?>Model_<?=$this->_getClassName($key['foreign_tbl_name'])?> $data)
    {
...
<?php endif; ?>
     ...
     * @return <?=$this->_namespace?>Model_<?=$this->_getClassName($key['foreign_tbl_name']) . "\n"?>
     */
...
<?php if ($key['type'] == 'one') :?>
     ...
     * @return <?=$this->_namespace?>Model_<?=$this->_className . "\n"?>
     */
    public function set<?=$this->_getRelationName($key, 'dependent')?>(<?=$this->_namespace?>Model_<?=$this->_getClassName($key['foreign_tbl_name'])?> $data)
    {
...
<?php else: ?>
     ...
     *
     * @param array $data An array of <?=$this->_namespace?>Model_<?=$this->_getClassName($key['foreign_tbl_name']) . "\n"?>
     * @return <?=$this->_namespace?>Model_<?=$this->_className . "\n"?>
     */
     ...
     * @return <?=$this->_namespace?>Model_<?=$this->_className . "\n"?>
     */
    public function add<?=$this->_getRelationName($key, 'dependent')?>(<?=$this->_namespace?>Model_<?=$this->_getClassName($key['foreign_tbl_name'])?> $data)
    {
        $this->_<?=$this->_getRelationName($key, 'dependent')?>[] = $data;
        return $this;
    }
     ...
     *
     * @param boolean $load Load the object if it is not already
     * @return array The array of <?=$this->_namespace?>Model_<?=$this->_getClassName($key['foreign_tbl_name']) . "\n"?>
     */
    public function get<?=$this->_getRelationName($key, 'dependent')?>($load = true)
    {
        if ($this->_<?=$this->_getRelationName($key, 'dependent')?> === null && $load) {
...
<?php endforeach; ?>
     ...
     *
     * @return <?=$this->_namespace?>Model_Mapper_<?=$this->_className . "\n"?>
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            $this->setMapper(new <?=$this->_namespace?>Model_Mapper_<?=$this->_className?>());
        }
     ...
     *
	 * @see <?=$this->_namespace?>Model_Mapper_<?=$this->_className?>::delete
